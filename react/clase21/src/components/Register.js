...
const schema = yup.object().shape({
    nombre: yup.string().required("El nombre es obligatorio").min(3, "Minimo 3 caracteres").max(30, "El nombre no puede contener mas de 30 caracteres"),
    apellido: yup.string().required("El apellido es obligatorio").max(30, "El apellido no puede contener mas de 30 caracteres"),
